		...
		<div class="content-wrapper" style="background:#f4f6fb;">
			<section class="content-header" style="background:#0c1a2e; padding: 16px 24px;">
              ...
              <ol class="breadcrumb" style="background:transparent; margin:4px 0 0; padding:0;">
                ...
                <li class="active" style="color:#fff;">Thêm Sản Phẩm</li>
              </ol>
            </section>
			...
			<section class="content">
                <div class="box box-primary" style="border-radius: 10px; box-shadow: 0 4px 18px rgba(0,0,0,0.08); border-top-color: #1a73e8;">
                    <div class="box-body" style="padding: 30px;">
						...
						<form:form action="productManager/save" modelAttribute="productForm" method="post" cssClass="form-horizontal">
							...
							<div class="form-group" style="margin-top:40px;">
								<div class="col-sm-offset-2 col-sm-8">
									<button type="submit" class="btn btn-primary" style="background: linear-gradient(135deg, #1a73e8, #4facfe); border:none; padding:10px 30px; border-radius:8px; font-weight:600; box-shadow: 0 4px 12px rgba(26,115,232,0.3);"><i class="fa fa-save"></i> Lưu Sản Phẩm</button>
								</div>
							</div>
						</form:form>
					</div>
